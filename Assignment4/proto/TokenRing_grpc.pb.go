...
const (
	TokenRing_RequestToken_FullMethodName = "/Assignment4.TokenRing/RequestToken"
	TokenRing_PassToken_FullMethodName    = "/Assignment4.TokenRing/PassToken"
)
...
type TokenRingClient interface {
	RequestToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*Acknowledgement, error)
	PassToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*Acknowledgement, error)
}
...
func (c *tokenRingClient) RequestToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*Acknowledgement, error) {
...
func (c *tokenRingClient) PassToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*Acknowledgement, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Acknowledgement)
...
type TokenRingServer interface {
	RequestToken(context.Context, *TokenRequest) (*Acknowledgement, error)
	PassToken(context.Context, *Token) (*Acknowledgement, error)
...
func (UnimplementedTokenRingServer) RequestToken(context.Context, *TokenRequest) (*Acknowledgement, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestToken not implemented")
}
func (UnimplementedTokenRingServer) PassToken(context.Context, *Token) (*Acknowledgement, error) {
...
var TokenRing_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "Assignment4.TokenRing",
